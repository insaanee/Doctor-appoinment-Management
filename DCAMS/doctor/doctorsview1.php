...
if ($result = $mysqli->query("SELECT * FROM doctors ORDER BY id"))
{
...
// set table headers
echo "<tr><th>ID</th><th>Specilization</th><th>Name</th><th>Address</th><th>Fees</th><th>Contact No</th><th>Email</th><th>Creation Date</th><th>Updation Date</th><th></th><th></th></tr>";
