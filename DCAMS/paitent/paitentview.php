...
if ($result = $mysqli->query("SELECT * FROM paitent ORDER BY id"))
{
...
// set table headers
echo "<tr><th>ID</th><th>Name</th><th>Problem</th><th>Address</th><th>Contact No</th><th>Email</th><th>Creation Date</th><th>Updation Date</th><th></th><th></th></tr>";
