...
if ($result = $mysqli->query("SELECT * FROM doctorspecilization ORDER BY id"))
{
...
// set table headers
echo "<tr><th>ID</th><th>Specilization</th><th>Creation Date</th><th>Updation Date</th><th></th><th></th></tr>";
